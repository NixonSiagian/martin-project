...
petik = '```'
fake = 'CREATOR BOT\Martinn'//GANTI NAMA KAMU BEP
ban =[]
	...
	try {
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/ganteng.jpg`)},"title": `HALLO...${pushname}JANGAN LUPA DI ORDER`,"description": "RAMA KANG TOLOL", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Martin-Botz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        case 'menu':
        case 'help':
        menu =`Hai Kak.....\n*${pushname}*\n\`\`\`Saya Martin-BOT, SENANG BISA BERTEMU DENGANMU HARI INI\`\`\`
...
©Martin 2021`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`Credit: Martin\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `Hai kak.....\n*${pushname}*\nJangan Lupa Donate Ya Agar Bot Bisa Online Terus`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe YT BlazeGamers YT\n Help me to 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI LORD MARTIN\`\`\`')
...
break
       case 'attp':
              if (args.length == 0) return reply(`Example: ${prefix + command} Martin`)
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *Martin* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`Martin-Botz ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
"groupName": `Martin-Botz ~ 404 ${vipi}`,
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`Jangan Lupa Subscribe YT Owner:\n https://youtube.com/channel/UCH4T_ZNgXW6sikUPL29tRHg`)
              break
       case 'masukandata':
...
case 'getvn':
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             sendMess(_.jid, `*「 PESAN SIARAN Martin-Botz」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
//------------------< serti menu >-------------------   
case 'sertitolol': 				
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}tololserti WILLIAM GAMTENG`)
				ct = body.slice(12)
...
case 'tahta':
         ...
         break    
case 'pornhub':
         if (args.length == 0) return reply(`Contoh: ${prefix + command} Martin-Botz`)
         txt1 = args[0]
         txt2 = args[1]
